...
import { loginApi, verifyOtpApi } from '../Action/api';
      ...
      {step === 'login' ? (
        ...
        <>
          <div className="mb-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2 tracking-tight">Security Verification</h2>
